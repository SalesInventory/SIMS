<%@ Page Title="" Language="C#" MasterPageFile="~/common/masters/mstcommon.Master" AutoEventWireup="true" CodeBehind="barcodeforprint.aspx.cs" Inherits="SIMS.common.barcodeforprint" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cpHead" runat="server">
    <script src='<%=ResolveUrl("~/js/common/barcodeforprint.js")%>'></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cpContent" runat="server">
    <form id="form1" runat="server">
        ...
        <div class="padding-bottom-10">
            <button id="btnAppraiserSteps" type="button" onclick="printDiv('plBarCode');;return false;" class="btn btn-default appraisal-btn">
                ...
                <span id="btnAppraiserStepsText">Print Barcodes</span></button>
        </div>

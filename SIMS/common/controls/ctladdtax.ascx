<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ctladdtax.ascx.cs" Inherits="SIMS.common.controls.ctladdtax" %>
<script src='<%=ResolveUrl("~/js/common/ctladdtax.js") %>'></script>
<div class="appraisal-overlay notification-window">
    <div class="modal fade" id="mdlTAxDetails" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="overlay-form">
                    <div class="modal-body clearfix">
                        <h3 class="text-uppercase text-center">Tax Details<span class="pull-right close margin-right-10" data-dismiss="modal" onclick="HideCoveragePopup()" style="font-size: 16px;">x</span></h3>
                            ...
                            <form id="frmVendorDetails" class="signup-form-2" enctype="multipart/form-data" role="form">
                                <div class="divider col-6 clearfix">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="txtName" name="txtName" placeholder="Name" type="text" />
                                    </div>
                                    <div class="form-group">
                                        <label for="lblFirstName">Percentage</label>
                                        <input class="form-control" id="txtPercentage" name="txtPercentage" placeholder="Percentage" type="text" />
                                    </div>
                                </div>
                                <div class="col-12 text-center padding-10">
                                    ...
                                    <button id="btnAppraiserBackSteps2" type="button" onclick="HideTaxModal();return false;" class="btn btn-default appraisal-btn">
                                        <svg width="16px" height="16px" viewBox="0 0 17 16" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <g transform="translate(-873.000000, -760.000000)" fill="#17A1E5">
                                                    <g transform="translate(599.000000, 90.000000)">

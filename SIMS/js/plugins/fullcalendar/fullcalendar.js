...
(function (factory) {
    ...
    function formatRangeWithChunks(date1, date2, chunks, separator, isRTL) {
        ...
        var lmrStr = leftStr + middleStr + rightStr;

        if (lmrStr.indexOf(':') == -1) {
            if (!leftStr && !rightStr) {
                var middleStr1split = middleStr1.split(',');
                var middleStr2split = middleStr2.split(',');
                lmrStr = '<div class="pull-left"><h4 class="no-margin">' + middleStr1split[0] + '&nbsp;&nbsp;-&nbsp;&nbsp;</h4><small style="float: left;">' + middleStr1split[1] + '</small></div>' +
                    '<div class="pull-left"><h4 class="no-margin">' + middleStr2split[0] + '</h4><small style="float: left;">' + middleStr2split[1] + '</small></div>';
            } else {
                var txtl = '';
                if (lmrStr.indexOf(',') < 0)
                    txtl = lmrStr.split(' ');
                ...
                lmrStr = '<h4 class="no-margin">' + txtl[0] + '</h4><small style="float: left;">' + txtl[1] + '</small>';
            }
        } else {
            lmrStr = lmrStr.split('-')[0];
        }
        /*Added by Kamal End*/
    ...
    */
    ...
    function Header(calendar, options) {
        ...
        function render() {
            ...
            if (sections) {
                ...
                el.appendTo('#calenderHeader');
                //$('#calenderHeader').add(el[0]);
                return $(); //el;
            }
        }
            ...
            if (buttonStr) {
                $.each(buttonStr.split(' '), function (i) {
                    ...
                    $.each(this.split(','), function (j, buttonName) {
                        ...
                        if (buttonName == 'title') {
                            groupChildren = groupChildren.add($('<h class="pull-left margin-left-5">&nbsp;</h>')); // we always want it to take up height <h4>&nbsp;</h4> <div class="pull-left"></div>
                            isOnlyButtons = false;
                        }
                        else {
                            ...
                            if (buttonClick) {
                                ...
                                if (buttonName == 'prev') {
                                    innerHtml = '';
                                    classes = [
                                        'btn-action padding-15 btn-' + buttonName + ' pull-left'
                                    ];
                                }
                                ...
                                if (position == 'right') {
                                    var classesforli = '';
                                    if (buttonName == 'month') { classesforli = 'active'; }
                                    buttonString = '<li onclick="checkActive(this)" class= "'+ classesforli +'"><a href="javascript:void(0);"><h3 id="calender-' + buttonName + '">0</h3><div>' + innerHtml + '</div></a></li>';
                                } else {
                                    buttonString = '<button type="button" class="' + classes.join(' ') + '">' +
                                        innerHtml +
                                    '</button>';
                                }
                                /* Edit By Kamal*/
                                ...
                                //if (position == 'right') {
                                //    groupChildren = groupChildren.find('ul').append(button);
                                //} else {
                    ...
                    if (groupChildren.length > 1) {
                        ...
                        if (isOnlyButtons) {
                            if (position == 'right') { 
                                groupEl.addClass('tab-content pull-right col-lg-5 col-el-5 no-padding'); }
                            else {
                                groupEl.addClass('fc-button-group');
                            }
                        }
                        if (position == 'right') {
                            groupEl.append('<div role="tabpanel" class="dashboard-menu tab-pane active"><ul class="list-unstyled"></ul></div>');
                            groupEl.find('ul').append(groupChildren);
                            groupEl.find('ul').append('<li><a href="javascript:void(0);"><h3 id="calender-seldate"></h3><div>Selected</div></a></li>');
                        } else {
        ...
        function updateTitle(text) {
            ...
            //    txtl = text.split(',');
            el.find('h').html(text);
            //el.find('h').html('<h4 class="no-margin">' + txtl[0] + '</h4><small style="float: left;">' + txtl[1] + '</small>');
        }
    ...
    var BasicView = fcViews.basic = View.extend({
        ...
        numberCellHtml: function (cell) {
            ...
            var daytext = date.date();
            if (classes.join(' ').indexOf('fc-today') >= 0) { daytext = '<strong>' + 'Today - ' + daytext + '</strong>'; }
            return '' +
    ...
    fcViews.agenda = View.extend({ // AgendaView
        ...
        axisStyleAttr: function () {
            if (this.axisWidth !== null) {
                return 'style="width:' + this.axisWidth + 'px !important"';
            }
            return '';
        },

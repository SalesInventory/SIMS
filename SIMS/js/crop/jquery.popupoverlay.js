        ...
        _initonce: function (el) {
            ...
            if (options.scrolllock) {
                ...
                if (typeof scrollbarwidth === 'undefined') {
                    parent = $('<div style="width:50px;height:50px;overflow:none"><div/></div>').appendTo('body');
            ...
            if (options.blur) {
                blurhandler = function (e) {
                    if (!$(e.target).parents().andSelf().is('#' + el.id)) {
                        //Hardik Shah [14 March 2014] - Do not close the popup when user clicks outside the popup boundries.
                        //methods.hide(el);
                    }
                };
            }

!function (a) {
    a.extend(a.fn, {
        ...
        defaults: {
            messages: {}, groups: {}, rules: {}, errorClass: "invalid", validClass: "valid", errorElement: "em", focusInvalid: !0, errorContainer: a([]), errorLabelContainer: a([]), onsubmit: !0, ignore: ":hidden", ignoreTitle: !1, onfocusin: function (a) {
        ...
        }, classRuleSettings: { required: { required: !0 }, zip: { zip: !0 }, phonenum: { phonenum: !0 }, email: { email: !0 }, url: { url: !0 }, date: { date: !0 }, dateISO: { dateISO: !0 }, number: { number: !0 }, digits: { digits: !0 }, creditcard: { creditcard: !0 } }, addClassRules: function (b, c) {
            ...
            }, phonenum: function (a, b) {
                a = a.replace(/[^\w]/gi, '');
                return this.optional(b) || /^\d{10}$/.test(a);
            }, date: function (a, b) {
            ...
            }, regularAmount: function (a, b, c) {
                return $("#txtRegularPrice").val() >= $("#txtAmount").val();

...
{
	/// <summary>
	/// BLL class for ProductStatusMaster table.
	/// </summary>
	public sealed class ProductStatusMasterBLL
	{
		#region Variables
		...
		public ProductStatusMasterBLL(int __iD)
		{
			 LoadProperties(SIMSClassLibrary.DAL.ProductStatusMaster.GetRecord(__iD));
		}
		...
		public void Save()
		{
			_ID = SIMSClassLibrary.DAL.ProductStatusMaster.Save(_ID, _Name, _CreatedOn, _UpdatedOn, _CreatedBy, _UpdatedBy);
		}

		public static DataTable GetAllRecords()
		{
			DataSet ds = SIMSClassLibrary.DAL.ProductStatusMaster.GetAllRecords();
		...
		{
			return SIMSClassLibrary.DAL.ProductStatusMaster.Delete(__iD);
		}

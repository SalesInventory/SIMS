...
namespace SIMSClassLibrary.BLL
{
	...
	public sealed class ProductSizeMasterBLL
	{
		...
		public ProductSizeMasterBLL(int __iD)
		{
			 LoadProperties(SIMSClassLibrary.DAL.ProductSizeMaster.GetRecord(__iD));
		}
		...
		public void Save()
		{
			_ID = SIMSClassLibrary.DAL.ProductSizeMaster.Save(_ID, _ProductCategoryID, _Name, _CreatedOn, _UpdatedOn, _CreatedBy, _UpdatedBy);
		}
		...
		{
			return SIMSClassLibrary.DAL.ProductSizeMaster.Delete(__iD);
		}

...
namespace SIMSClassLibrary.DAL
{
	...
	public sealed class ProductBarcodeDetails
	{
		...
		/// <param name="__productDetailsID"></param>
		...
		/// <returns></returns>
		public static int Save(int __iD, int __productDetailsID, string __barcodeNumber, DateTime __createdOn, DateTime __updatedOn, int __createdBy, int __updatedBy)
		{
			Database db = DatabaseFactory.CreateDatabase();
			DbCommand dbCommand = db.GetStoredProcCommand("ProductBarcodeDetailsSave");

			db.AddInParameter(dbCommand, "ID", DbType.Int32, __iD);
			db.AddInParameter(dbCommand, "ProductDetailsID", DbType.Int32, __productDetailsID);
